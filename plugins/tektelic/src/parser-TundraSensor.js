    ...
    for (let i = 0; i < bytes.length; ) {
      ...
      if (channel === 0x00 && type === 0xff) {
        ...
        array_result.push({
          ...
          value: Number((battery_voltage * 0.01).toFixed(2)),
          unit: "V",
        });
        i += 2;
      }
      ...
      if (channel === 0x0b && type === 0x67) {
        ...
        array_result.push({
          ...
          value: Number((mcu_temperature * 0.1).toFixed(2)),
          unit: "°C",
        });
        i += 2;
      }
      ...
      if (channel === 0x03 && type === 0x67) {
        ...
        array_result.push({
          ...
          value: Number((ambient_temperature * 0.1).toFixed(2)),
          unit: "°C",
        });
        i += 2;
      }
      ...
      if (channel === 0x05 && type === 0x02) {
        ...
        array_result.push({
          variable: "acceleration_magnitude",
          value: acceleration_magnitude,
          unit: "g",
        });
        i += 2;
      }
      ...
      if (channel === 0x07 && type === 0x71) {
        ...
        array_result.push({
          variable: "acceleration_x_axis",
          value: acceleration_vector_x,
          unit: "g",
        });
        const acceleration_vector_y = (bytes[i + 2] << 8) | bytes[i + 3];
        array_result.push({
          variable: "acceleration_y_axis",
          value: acceleration_vector_y,
          unit: "g",
        });
        const acceleration_vector_z = (bytes[i + 4] << 8) | bytes[i + 5];
        array_result.push({
          variable: "acceleration_z_axis",
          value: acceleration_vector_z,
          unit: "g",
        });
        i += 6;
      }
  ...
  if (port === 32) {
    ...
    for (let i = 0; i < bytes.length; ) {
      ...
      if (channel === 0x04 && type === 0x68) {
        ...
        array_result.push({
          variable: "ambient_rh",
          value: Number((ambient_rh * 0.5).toFixed(2)),
          unit: "%",
        });
        i += 1;
      }
